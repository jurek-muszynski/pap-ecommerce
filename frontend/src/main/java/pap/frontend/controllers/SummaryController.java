...
public class SummaryController extends AuthenticatedController {
    ...
    private void sendOrderConfirmationEmail(String email, String deliveryAddress) throws MessagingException, IOException {
        ...
        props.put("mail.smtp.ssl.enable", "true"); // W≈***REMOVED***ƒÖczenie SSL
        ...
        Session session = Session.getInstance(props, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(from, password); // Autentykacja za pomocƒÖ adresu e-mail i has≈***REMOVED***a
            }
        });
        ...
        // Wysy≈***REMOVED***anie wiadomo≈õci
        Transport.send(message);
    }

    private Properties loadProperties() throws IOException {
        Properties properties = new Properties();
        // ≈Åadowanie pliku properties
